...
class WorkflowInteractionServiceUnitTest : ShouldSpec({
    ...
    context("readProjectInstanceInfo") {
        should("return instance info") {
            ...
            // when
            val returnedProjectInstanceInfo = cut.readProjectInstanceInfo(projectEntity.id)

            // then
            returnedProjectInstanceInfo.projectId shouldBe projectEntity.id
            returnedProjectInstanceInfo.orgUnitId shouldBe projectEntity.orgUnit.id

            val returnedNodeInfo = returnedProjectInstanceInfo.instanceInfo
