...
class CreatorOrOrgUnitAccessRuleUnitTest : ShouldSpec({
    ...
    context("valid") {
        ...
        withData(
            ...
            AccessData(creatorId, AccessLevel.USE, "should pass for the creator holding USE"),
            AccessData(creatorId, AccessLevel.CONFIGURE, "should pass for the creator holding CONFIGURE"),
        ...
        withData(
            ...
            AccessData(otherUserId, AccessLevel.USE, "should refuse another member holding USE"),
            AccessData(otherUserId, AccessLevel.CONFIGURE, "should refuse another member holding CONFIGURE"),
