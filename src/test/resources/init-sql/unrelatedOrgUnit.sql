...
INSERT INTO workflows VALUES(nextval('workflow_id_seq'), 'Unrelated flow', 1, now());
INSERT INTO workflow_nodes VALUES(nextval('node_id_seq'), currval('workflow_id_seq'), 'start', 'start', 'Start', 'WORKFLOW');
INSERT INTO workflow_instances VALUES(2000, currval('node_id_seq'), true, null, 'DEFAULT');

INSERT INTO projects (id, name, short_description, group_id, instance_id, org_unit_id, created_by, created_on)
VALUES (2000, 'UNRELATED PROJECT', 'Belongs to the unrelated org unit', 2000, 2000, 2000, 2000, now());
