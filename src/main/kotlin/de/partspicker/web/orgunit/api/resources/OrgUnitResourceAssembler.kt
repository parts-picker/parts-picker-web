...
import de.partspicker.web.common.hal.generateGetAllMembershipsOfCurrentUserLink
...
class OrgUnitResourceAssembler : RepresentationModelAssembler<OrgUnit, OrgUnitResource> {
    ...
    private fun generateDefaultLinks(orgUnitId: Long): List<Link> {
        return listOf(
            ...
            generateGetAllMembershipsOfCurrentUserLink(IanaLinkRelations.COLLECTION),
            generatePostOrgUnitLink(IanaLinkRelations.COLLECTION),
