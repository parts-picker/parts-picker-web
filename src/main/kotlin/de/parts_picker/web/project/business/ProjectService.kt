package de.parts_picker.web.project.business
...
import de.parts_picker.web.project.persistance.GroupRepository
import de.parts_picker.web.project.persistance.ProjectRepository
...
class ProjectService (
    ...
    fun removeGroupForAllById(groupId: Long) {
        val projects = this.findAllByGroupId(groupId).map{
                project -> project.copy(group = null)
        }
