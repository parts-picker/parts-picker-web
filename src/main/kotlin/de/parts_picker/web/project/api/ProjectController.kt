...
import de.parts_picker.web.project.api.requests.PostProjectRequest
import de.parts_picker.web.project.api.requests.PutProjectRequest
import de.parts_picker.web.project.api.requests.asEntity
import de.parts_picker.web.project.api.responses.ProjectIterableResponse
import de.parts_picker.web.project.api.responses.ProjectResponse
import de.parts_picker.web.project.api.responses.asResponse
import de.parts_picker.web.project.business.ProjectService
...
class ProjectController (private val projectService: ProjectService){
    ...
    fun handleModifyProject(@PathVariable id: Long, @RequestBody body: PutProjectRequest): ResponseEntity<ProjectResponse> {
